...
import com.chickens.common.exception.ReviewNotFoundException;
import com.chickens.order.OrderDetailRepository;
	...
	public Review getByCustomerAndId(Customer customer, Integer reviewId) throws ReviewNotFoundException {
		...
		if (review == null) 
			throw new ReviewNotFoundException("\r\n"
					+ "Khách hàng không có bất kỳ đánh giá nào với ID " + reviewId);

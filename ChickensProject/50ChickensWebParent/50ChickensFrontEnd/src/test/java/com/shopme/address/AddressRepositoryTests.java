...
import com.chickens.address.AddressRepository;
...
public class AddressRepositoryTests {
	...
	/*
	 * @Test public void testFindByCustomer() { Integer customerId = 5;
	 ...
	 * 
	 * @Test public void testFindByIdAndCustomer() { Integer addressId = 1; Integer
	 * customerId = 5;
	 * 
	 * Address address = repo.findByIdAndCustomer(addressId, customerId);
	 * 
	 * assertThat(address).isNotNull(); System.out.println(address); }
	 * 
	 * @Test public void testUpdate() { Integer addressId = 1; String phoneNumber =
	 * "646-232-3932";
	 * 
	 ...
	 * 
	 * @Test public void testDeleteByIdAndCustomer() { Integer addressId = 1;
	 * Integer customerId = 5;
	 * 

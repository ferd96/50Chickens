...
import com.chickens.shoppingcart.CartItemRepository;
...
public class CartItemRepositoryTests {
	...
	/*
	 * @Test public void testFindByCustomer() { Integer customerId = 10;
	 ...
	 * 
	 * @Test public void testFindByCustomerAndProduct() { Integer customerId = 1;
	 * Integer productId = 1;
	 * 
	 * CartItem item = repo.findByCustomerAndProduct(new Customer(customerId), new
	 * Product(productId));
	 * 
	 ...
	 * 
	 * @Test public void testUpdateQuantity() { Integer customerId = 1; Integer
	 * productId = 1; Integer quantity = 4;
	 * 
	 ...
	 * 
	 * @Test public void testDeleteByCustomerAndProduct() { Integer customerId = 10;
	 * Integer productId = 10;
	 * 
